...
router.get('/',checkLoginUser, function(req, res, next) {
  ...
  res.render('edit_password_detail', { title: ' Management System',loginUser: loginUser,records:data1,record:data,success:'' });
  });
  });
  });
  ...
  if(err) throw err;
  getPassCat.exec(function(err,data1){
  res.render('edit_password_detail', { title: ' Management System',loginUser: loginUser,records:data1,record:data,success:'Password Updated Successfully' });
  });
  });
  });
  });
